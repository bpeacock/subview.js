...
<section class='important'>
    <strong>Important:</strong> Make sure to use the instance of subview on the global (`window`) object to ensure that your extension is built using whatever version of subview is present on the page.
</section>
